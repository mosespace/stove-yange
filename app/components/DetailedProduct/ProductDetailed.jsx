...
import DemoImg from "../../../public/burner-01.jpg";
import DemoImg2 from "../../../public/burner-02.jpg";
import Link from "next/link";
export default function ProductDetailed({ product, category, subCategory }) {
  return (
        ...
        <div className='lg:col-gap-8 xl:col-gap-16 mt-8 grid  grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16'>
          ...
          <div className='lg:col-span-2 lg:row-span-2 lg:row-end-2'>
            ...
            <h2 className='mt-8 text-base text-gray-900'>
              {product.title.substring(0, 20)} Type
            </h2>
            ...
            <div className='mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0'>
              ...
              <button
                type='button'
                className='inline-flex items-center justify-center rounded-md border-2 border-transparent bg-[#0E7490]  bg-none px-12 py-3 text-center text-base font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-800'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='lg:col-span-3'>
            ...
            <div className='mt-8 flow-root sm:mt-12'>
              ...
              <h1 className='mt-8 text-3xl font-bold'>Detailed Description</h1>
